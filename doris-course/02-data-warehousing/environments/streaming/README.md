...
- **Interrupted Kafka notebook:** in `dw_course_l1_streaming`, run `SHOW ROUTINE LOAD`, identify this run's job, and execute `STOP ROUTINE LOAD FOR <course-job-name>` before starting a new experiment. Do not stop jobs in other databases.
