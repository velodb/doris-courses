...
| 环节 | 学习形式 | 建议时间 | 学习成果 |
| --- | --- | --- | --- |
| D09-01：Schema 与业务质量 | 字段与规则对照 | 5 分钟 | 说明类型正确为何不等于业务正确 |
| D09-02：暂存与拒收 | 输入与分流结果 | 5 分钟 | 追踪原始字段和每条拒收原因 |
| D09-03：质量测试与验收 | 错误注入案例 | 5 分钟 | 证明检查能发现已知错误 |
| 实验 9A | 动手操作 | 20 分钟 | 完成 13→10＋3 分流，生成 D06 合格输入 |
| 测验 9A | 交互测验 | 5 分钟 | 检查规则、来源、分流、对账和校验有效性 |
